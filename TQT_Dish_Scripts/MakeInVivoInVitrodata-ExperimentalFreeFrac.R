...
InVivoPos<- read.csv("InVivoPred-ExperimentalFreeFrac.pos.csv", header=TRUE)
InVivoNeg<- read.csv("InVivoPred-ExperimentalFreeFrac.neg.csv", header=TRUE)
...
for (j in 1:nrow(chemmap)) {
  ...
  simframe_22<-data.frame(y0=c((eval(parse(text=files[1])))[2005:4004, "y0.22"], (eval(parse(text=files[2])))[2005:4004, "y0.22"], (eval(parse(text=files[3])))[2005:4004, "y0.22"], (eval(parse(text=files[4])))[2005:4004, "y0.22"]),
                          x0=c((eval(parse(text=files[1])))[2005:4004, "x0.22"], (eval(parse(text=files[2])))[2005:4004, "x0.22"], (eval(parse(text=files[3])))[2005:4004, "x0.22"], (eval(parse(text=files[4])))[2005:4004, "x0.22"]), 
                          Emax=c((eval(parse(text=files[1])))[2005:4004, "Emax.22"], (eval(parse(text=files[2])))[2005:4004, "Emax.22"], (eval(parse(text=files[3])))[2005:4004, "Emax.22"], (eval(parse(text=files[4])))[2005:4004, "Emax.22"]), 
                          n=c((eval(parse(text=files[1])))[2005:4004, "n.22"], (eval(parse(text=files[2])))[2005:4004, "n.22"], (eval(parse(text=files[3])))[2005:4004, "n.22"], (eval(parse(text=files[4])))[2005:4004, "n.22"]))
  
  #### Standard donor (cell line 11)
  simframe_11<-data.frame(y0=c((eval(parse(text=files[1])))[2005:4004, "y0.11"], (eval(parse(text=files[2])))[2005:4004, "y0.11"], (eval(parse(text=files[3])))[2005:4004, "y0.11"], (eval(parse(text=files[4])))[2005:4004, "y0.11"]),
                          x0=c((eval(parse(text=files[1])))[2005:4004, "x0.11"], (eval(parse(text=files[2])))[2005:4004, "x0.11"], (eval(parse(text=files[3])))[2005:4004, "x0.11"], (eval(parse(text=files[4])))[2005:4004, "x0.11"]), 
                          Emax=c((eval(parse(text=files[1])))[2005:4004, "Emax.11"], (eval(parse(text=files[2])))[2005:4004, "Emax.11"], (eval(parse(text=files[3])))[2005:4004, "Emax.11"], (eval(parse(text=files[4])))[2005:4004, "Emax.11"]), 
                          n=c((eval(parse(text=files[1])))[2005:4004, "n.11"], (eval(parse(text=files[2])))[2005:4004, "n.11"], (eval(parse(text=files[3])))[2005:4004, "n.11"], (eval(parse(text=files[4])))[2005:4004, "n.11"]))
  
  #### Standard donor (cell line 6)
  simframe_6<-data.frame(y0=c((eval(parse(text=files[1])))[2005:4004, "y0.6"], (eval(parse(text=files[2])))[2005:4004, "y0.6"], (eval(parse(text=files[3])))[2005:4004, "y0.6"], (eval(parse(text=files[4])))[2005:4004, "y0.6"]),
                         x0=c((eval(parse(text=files[1])))[2005:4004, "x0.6"], (eval(parse(text=files[2])))[2005:4004, "x0.6"], (eval(parse(text=files[3])))[2005:4004, "x0.6"], (eval(parse(text=files[4])))[2005:4004, "x0.6"]), 
                         Emax=c((eval(parse(text=files[1])))[2005:4004, "Emax.6"], (eval(parse(text=files[2])))[2005:4004, "Emax.6"], (eval(parse(text=files[3])))[2005:4004, "Emax.6"], (eval(parse(text=files[4])))[2005:4004, "Emax.6"]), 
                         n=c((eval(parse(text=files[1])))[2005:4004, "n.6"], (eval(parse(text=files[2])))[2005:4004, "n.6"], (eval(parse(text=files[3])))[2005:4004, "n.6"], (eval(parse(text=files[4])))[2005:4004, "n.6"]))
  
  #### Standard donor (cell line 3)
  simframe_3<-data.frame(y0=c((eval(parse(text=files[1])))[2005:4004, "y0.3"], (eval(parse(text=files[2])))[2005:4004, "y0.3"], (eval(parse(text=files[3])))[2005:4004, "y0.3"], (eval(parse(text=files[4])))[2005:4004, "y0.3"]),
                         x0=c((eval(parse(text=files[1])))[2005:4004, "x0.3"], (eval(parse(text=files[2])))[2005:4004, "x0.3"], (eval(parse(text=files[3])))[2005:4004, "x0.3"], (eval(parse(text=files[4])))[2005:4004, "x0.3"]), 
                         Emax=c((eval(parse(text=files[1])))[2005:4004, "Emax.3"], (eval(parse(text=files[2])))[2005:4004, "Emax.3"], (eval(parse(text=files[3])))[2005:4004, "Emax.3"], (eval(parse(text=files[4])))[2005:4004, "Emax.3"]), 
                         n=c((eval(parse(text=files[1])))[2005:4004, "n.3"], (eval(parse(text=files[2])))[2005:4004, "n.3"], (eval(parse(text=files[3])))[2005:4004, "n.3"], (eval(parse(text=files[4])))[2005:4004, "n.3"]))
...
save(data.list,chemmap,file="InVivoInVitrodat-ExperimentalFreeFrac.Rdata")
beep(sound=3)