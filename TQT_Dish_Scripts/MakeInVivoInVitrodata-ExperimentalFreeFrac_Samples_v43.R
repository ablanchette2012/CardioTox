...
for (j in 1:nrow(chemmap)) {
  ...
  simframe_27<-data.frame(y0=c((eval(parse(text=files[1])))[2:2001, "y0.43"], (eval(parse(text=files[2])))[2:2001, "y0.43"], (eval(parse(text=files[3])))[2:2001, "y0.43"], (eval(parse(text=files[4])))[2:2001, "y0.43"]),
                          x0=c((eval(parse(text=files[1])))[2:2001, "x0.43"], (eval(parse(text=files[2])))[2:2001, "x0.43"], (eval(parse(text=files[3])))[2:2001, "x0.43"], (eval(parse(text=files[4])))[2:2001, "x0.43"]), 
                          Emax=c((eval(parse(text=files[1])))[2:2001, "Emax.43"], (eval(parse(text=files[2])))[2:2001, "Emax.43"], (eval(parse(text=files[3])))[2:2001, "Emax.43"], (eval(parse(text=files[4])))[2:2001, "Emax.43"]), 
                          n=c((eval(parse(text=files[1])))[2:2001, "n.43"], (eval(parse(text=files[2])))[2:2001, "n.43"], (eval(parse(text=files[3])))[2:2001, "n.43"], (eval(parse(text=files[4])))[2:2001, "n.43"]))
