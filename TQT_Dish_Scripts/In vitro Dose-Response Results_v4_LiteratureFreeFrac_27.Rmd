---
title: "In vitro Dose-Response Results_v4_LiteratureFreeFrac"
...
# created by source("MakeInVivoInVitrodata-LiteratureFreeFrac.R")
load("InVivoInVitrodat-LiteratureFreeFrac_27.Rdata")
celllines<-as.character(read.csv("27Cell.lines.csv",as.is=TRUE)[,2])
...
for (j in 1:nrow(chemmap)) {
  with(data.list[[j]], {
    ...
    print(p2)
    if (j <= 10) {
    ggsave(paste(chemical.name,"27InVitroInVivoConcResp-LiteratureFreeFrac.pdf",sep="."),p2,
        height=3,width=5,dpi=600)
    } else {
    ggsave(paste(chemical.name,"27InVitroInVivoConcResp-LiteratureFreeFrac.pdf",sep="."),p1,
        height=3,width=5,dpi=600)
    }
  }
  )
...
print(p1)
ggsave("27InVitroInVivo-LiteratureFreeFrac.PopMed.ECmax.pdf",p1,height=5,width=7,dpi=600)
print(p2)
ggsave("27InVitroInVivo-LiteratureFreeFrac.StdDonor.ECmax.pdf",p2,height=5,width=7,dpi=600)
print(p3)
ggsave("27InVitroInVivo-LiteratureFreeFrac.ECmax.pdf",p3,
...
print(p1)
ggsave("27InVitroInVivo-LiteratureFreeFrac.PopMed.EC10.pdf",p1,height=5,width=7,dpi=600)
print(p2)
ggsave("27InVitroInVivo-LiteratureFreeFrac.StdDonor.EC10.pdf",p2,height=5,width=7,dpi=600)
print(p3)
ggsave("27InVitroInVivo-LiteratureFreeFrac.EC10.pdf",p3,
        height=5,width=11,dpi=600)
```
...
print(p1)
ggsave("27InVitroInVivo-LiteratureFreeFrac.PopMed.EC05.pdf",p1,height=5,width=7,dpi=600)
print(p2)
ggsave("27InVitroInVivo-LiteratureFreeFrac.StdDonor.EC05.pdf",p2,height=5,width=7,dpi=600)
print(p3)
ggsave("27InVitroInVivo-LiteratureFreeFrac.EC05.pdf",p3,
        height=5,width=11,dpi=600)
...
print(p1)
ggsave("27InVitroInVivo-LiteratureFreeFrac.PopMed.EC01.pdf",p1,height=5,width=7,dpi=600)
print(p2)
ggsave("27InVitroInVivo-LiteratureFreeFrac.StdDonor.EC01.pdf",p2,height=5,width=7,dpi=600)
print(p3)
ggsave("27InVitroInVivo-LiteratureFreeFrac.EC01.pdf",p3,
        height=5,width=11,dpi=600)
...
write.csv(allEC.df,"27IVIVE-LiteratureFreeFrac.csv")
