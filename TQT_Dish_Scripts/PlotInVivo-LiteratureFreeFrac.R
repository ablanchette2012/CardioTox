...
invivodf.pos <- read.csv("InVivoPred-LiteratureFreeFrac.pos.csv")
invivodf.neg <- read.csv("InVivoPred-LiteratureFreeFrac.neg.csv")

label_log10 <- function(x) parse(text = paste0('10^', log(x, 10)))

pdf("FoldChange.invivo-LiteratureFreeFrac.pos.pdf",width=6,height=8)
...
pdf("FoldChange.invivo-LiteratureFreeFrac.neg.pdf",width=6,height=8*2/5)
...
pdf("FracChange.invivo-LiteratureFreeFrac.pos.log.pdf",width=6,height=8)
