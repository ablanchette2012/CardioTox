...
InVivoPos<- read.csv("InVivoPred-LiteratureFreeFrac.pos.csv", header=TRUE)
InVivoNeg<- read.csv("InVivoPred-LiteratureFreeFrac.neg.csv", header=TRUE)
...
load("InVivoInVitrodat-ExperimentalFreeFrac.Rdata")
...
save(data.list,chemmap,file="InVivoInVitrodat-LiteratureFreeFrac.Rdata")
