...
###load packages and set DR functions
...
###set up master function

DR_master<- function(chemical.name){
  ...
  simframeconc$PredFold<- DR_up(x=simframeconc$concentration, y0=1, x0=simframeconc$sim_x0, Emax=simframeconc$sim_Emax, n=simframeconc$sim_n)*(scale_factor)
  ...
  simframeconc$PredFrac<- DR_up_Frac(x=simframeconc$concentration, y0=1, x0=simframeconc$sim_x0, Emax=simframeconc$sim_Emax, n=simframeconc$sim_n)*(scale_factor) 
  ...
  simframe_zero_conc$PredFold<- DR_up(x=simframe_zero_conc$concentration, y0=1, x0=simframe_zero_conc$x0, Emax=simframe_zero_conc$Emax, n=simframe_zero_conc$n)*(scale_factor)
  ...
  simframe_zero_conc$PredFrac<- DR_up_Frac(x=simframe_zero_conc$concentration, y0=1, x0=simframe_zero_conc$x0, Emax=simframe_zero_conc$Emax, n=simframe_zero_conc$n)*(scale_factor) 
