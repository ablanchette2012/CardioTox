...
setwd("C:\\Users\\ablanchette\\Documents\\dose_response_template\\dose_response_template\\N-Acetylprocainamide\\decay_rise_up")
...
InVivoPos<- read.csv("InVivoPred.pos.csv", header=TRUE)

InVivoParm<- read.csv("QTposnegparameters.csv", header=TRUE)

InVivo<-subset(InVivoPos, Chemical.name== "N-acetylprocainamide" )

InVivoFree<- subset(InVivoParm, ï..Chemical=="N-acetylprocainamide" )
