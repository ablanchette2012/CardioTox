...
setwd("C:\\Users\\ablanchette\\Documents\\dose_response_template\\dose_response_template\\Mifepristone\\decay_rise_up")
...
rm(standat_v3a_do_stan_fit_Peak_Decay_Rise_Ratio_up_29_samples_1.csv, standat_v3a_do_stan_fit_Peak_Decay_Rise_Ratio_up_29_samples_2.csv, standat_v3a_do_stan_fit_Peak_Decay_Rise_Ratio_up_29_samples_3.csv, standat_v3a_do_stan_fit_Peak_Decay_Rise_Ratio_up_29_samples_4.csv)

### Load in appropriate control CSV and Parameter CSV

InVivoNeg<- read.csv("InVivoPred.neg.csv", header=TRUE)

InVivoParm<- read.csv("QTposnegparameters.csv", header=TRUE)

InVivo<-subset(InVivoNeg, Chemical.name== "mifepristone" )

InVivoFree<- subset(InVivoParm, ï..Chemical=="mifepristone" )
...
write.csv(Simulation_Frame_Fold, "InVivo_Frame_Fold.csv")

write.csv(Simulation_Frame_Zero_Fold, "Invivo_Frame_Zero_Fold.csv")

write.csv(Simulation_Frame_Frac, "Invivo_Frame_Frac.csv")

write.csv(Simulation_Frame_Zero_Frac, "Invivo_Frame_Zero_Frac.csv")

write.csv(simframeconc, "Invivoframeconc.csv")

write.csv(simframe_zero_conc, "Invivoframe_zero_conc.csv")
...
ggplot(Simulation_Frame_Fold,aes(x=concentration, y=p50))+
  ...
  ggtitle("Mifepristone In Vitro vs. In Vivo Fold Change Peak Decay Rise Ratio Up (Log Scale)")+
...
ggplot(Simulation_Frame_Fold, aes(x=concentration, y=p50))+
  ...
  ggtitle("Mifepristone In Vivo vs. In Vitro Fold Change Peak Decay Rise Ratio Up")+
...
ggplot(Simulation_Frame_Frac, aes(x=concentration, y=p50))+
  ...
  ggtitle("Mifepristone In Vivo vs. In Vitro Fractional Change Peak Decay Rise Ratio Up (Log Scale)")+
...
ggplot(Simulation_Frame_Frac, aes(x=concentration, y=p50))+
  ...
  ggtitle("Mifepristone In Vivo vs. In Vitro Fractional Change Peak Decay Rise Ratio Up")+
